...
<body>
	...
	<form action="<?php echo base_url(). 'User/update'; ?>" method="post">
		<table style="margin:20px auto;">
			...
			<tr>
				<td>No. Hp</td>
				<td><input type="text" name="no_hp" value="<?php echo $users->no_hp ?>"></td>
			</tr>
			<tr>
				<td>Alamat</td>
				<td width="600px"><textarea type="text" name="alamat" value="<?php echo $users->alamat ?>"></textarea></td>
			</tr>
			<tr>
				<td>Email</td>
				<td><input type="email" name="email" value="<?php echo $users->email ?>"></td>
			</tr>
			<tr>
				<td>Keterangan</td>
				<td><input type="text" name="keterangan" value="<?php echo $users->keterangan ?>"></td>
			</tr>
			<tr>
				<td></td>
