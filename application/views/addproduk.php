...
<div class="container">
	...
	<div class="row">
			...
			<form action="<?php echo base_url()."index.php/produk/Addproduk"?>" method="post">
				<div class="form-group">
					<label for="nama">Nama Produk</label>
					<div class="col-sm-5">
					  <input type="text" name="nama" style="width:600px;" class="form-control" value="<?php echo set_value('nama'); ?>" placeholder="Masukkan nama produk" id="nama">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
					  <input type="text" name="serial_number" class="form-control" value="<?php echo set_value('serial_number');?>" placeholder="Masukkan Serial Number" id="no_hp">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
					  <input type="text" name="keterangan" class="form-control" value="<?php echo set_value('keterangan');?>" placeholder="Masukkan Keterangan" id="keterangan">
					</div>
				</div>
