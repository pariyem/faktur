...
<body>
  <?php
    foreach($dataFakturSuratJalan as $surat_jalan){ ?>
  <div class="span center">
	<h1 align="text-center"><?php echo $surat_jalan->nm_user ?></h1>
	<br>
	<h1 align="text-center"><?php echo $surat_jalan->pembeli ?></h1>
	<p align="text-center"><?php echo $surat_jalan->alamat ?></p>
  <?php } ?>
  </div>
 	...
 	<table>
		...
		<tbody>
			<tr style="background-color: #26216A;">		
				...
				<td>Rp <?php echo $surat_jalan->total_harga ?></td>
      </tr>
      <tr>
        <td style="background-color: #ffffff;"></td>
        <td style="background-color: #26216A; color: #FA7B06;"> Total Tagihan </td>
        <td style="background-color: #26216A; color: #FA7B06;"> Rp3.700.000</td>
      </tr>
