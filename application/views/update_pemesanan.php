...
<body>
	<center>
		<h1>Data Faktur Pemesanan</h1>
		<h3>Edit Data</h3>
	</center>
	<?php foreach($dataFakturPemesanan as $pemesanan){ ?>
	<form action="<?php echo base_url(). 'Faktur_Pemesanan/update'; ?>" method="post">
		<table style="margin:20px auto;">
			<tr>
				<td>Nama Instansi</td>
				<td>
					<input type="hidden" name="id" value="<?php echo $pemesanan->id ?>">
					<input type="text" name="pembeli" value="<?php echo $pemesanan->pembeli ?>">
				</td>
			</tr>
			<tr>
				<td align="left">Nama User</td>
				<td><input type="text" name="nm_user" value="<?php echo $pemesanan->nm_user ?>"></td>
			</tr>
			<tr>
				<td>Nama Barang</td>
				<td><input type="text" name="nm_brg" value="<?php echo $pemesanan->nm_brg ?>"></td>
			</tr>
			<tr>
				<td>Jumlah Barang</td>
				<td><input type="text" name="jml_brg" value="<?php echo $pemesanan->jml_brg ?>"></td>
			</tr>
			<tr>
				<td>Harga Satuan</td>
				<td><input type="text" name="hrg_satuan" value="<?php echo $pemesanan->hrg_satuan ?>"></td>
			</tr>
			<tr>
				<td>Alamat</td>
				<td width="600px"><textarea type="text" name="alamat" value="<?php echo $pemesanan->alamat ?>"></textarea></td>
			</tr>
			<tr>
				<td>PPN</td>
				<td><input type="text" name="PPN" value="<?php echo $pemesanan->PPN ?>"></td>
			</tr>
			<tr>
				<td>DP</td>
				<td><input type="text" name="DP" value="<?php echo $pemesanan->DP ?>"></td>
			</tr>
			<tr>
				<td>No. Hp</td>
				<td><input type="text" name="NO_HP" value="<?php echo $pemesanan->NO_HP ?>"></td>
			</tr>
			<tr>
				<td></td>
