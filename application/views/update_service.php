...
<body>
	<center>
		<h1>Data Faktur Service</h1>
		<h3>Edit Data</h3>
	</center>
	<?php foreach($dataservice as $surat_service){ ?>
	<form action="<?php echo base_url(). 'Faktur_Service/update'; ?>" method="post">
		<table style="margin:20px auto;">
			<tr>
				<td>Nama Instansi</td>
				<td>
					<input type="hidden" name="id" value="<?php echo $surat_service->id ?>">
					<input type="text" name="pembeli" value="<?php echo $surat_service->pembeli ?>">
				</td>
			</tr>
			<tr>
				<td align="left">Nama User</td>
				<td><input type="text" name="nm_user" value="<?php echo $surat_service->nm_user ?>"></td>
			</tr>
			<tr>
				<td>Nama Barang</td>
				<td><input type="text" name="nm_brg" value="<?php echo $surat_service->nm_brg ?>"></td>
			</tr>
			<tr>
				<td>Alamat</td>
				<td width="600px"><textarea type="text" name="alamat" value="<?php echo $surat_service->alamat ?>"></textarea></td>
			</tr>
			<tr>
				<td>Harga Satuan</td>
				<td><input type="text" name="hrg_satuan" value="<?php echo $surat_service->hrg_satuan ?>"></td>
			</tr>
			<tr>
				<td>Jumlah Barang</td>
				<td><input type="text" name="jml_brg" value="<?php echo $surat_service->jml_brg ?>"></td>
			</tr>
			<tr>
				<td>Keterangan</td>
				<td><input type="text" name="keterangan" value="<?php echo $surat_service->keterangan ?>"></td>
			</tr>
			
			<tr>
				<td>No. Hp</td>
				<td><input type="text" name="no_hp" value="<?php echo $surat_service->no_hp ?>"></td>
			</tr>
