...
<body>
	...
	<?php foreach($datatandalunas as $srt_td_lunas){ ?>
	<form action="<?php echo base_url(). 'Faktur_Tanda_Lunas/update'; ?>" method="post">
		<table style="margin:20px auto;">
			<tr>
				<td>Nama Instansi</td>
				<td>
					<input type="hidden" name="id" value="<?php echo $srt_td_lunas->id ?>">
					<input type="text" name="pembeli" value="<?php echo $srt_td_lunas->pembeli ?>">
				</td>
			</tr>
			<tr>
				<td align="left">Nama User</td>
				<td><input type="text" name="nm_user" value="<?php echo $srt_td_lunas->nm_user ?>"></td>
			</tr>
			<tr>
				<td>Nama Barang</td>
				<td><input type="text" name="nm_brg" value="<?php echo $srt_td_lunas->nm_brg ?>"></td>
			</tr>
			<tr>
				<td>Jumlah Barant</td>
				<td><input type="text" name="jml_brg" value="<?php echo $srt_td_lunas->jml_brg ?>"></td>
			</tr>
			<tr>
				<td>Harga Satuan</td>
				<td><input type="text" name="hrg_satuan" value="<?php echo $srt_td_lunas->hrg_satuan ?>"></td>
			</tr>
			<tr>
				<td>Alamat</td>
				<td width="600px"><textarea type="text" name="alamat" value="<?php echo $srt_td_lunas->alamat ?>"></textarea></td>
			</tr>
			<tr>
				<td>PPN</td>
				<td><input type="text" name="PPN" value="<?php echo $srt_td_lunas->PPN ?>"></td>
			</tr>
			<tr>
				<td>DP</td>
				<td><input type="text" name="DP" value="<?php echo $srt_td_lunas->DP ?>"></td>
			</tr>
			<tr>
				<td>No. Hp</td>
				<td><input type="text" name="NO_HP" value="<?php echo $srt_td_lunas->NO_HP ?>"></td>
			</tr>
			<tr>
				<td>Status</td>
				<td><input type="text" name="status" value="<?php echo $srt_td_lunas->status ?>"></td>
			</tr>
