...
<body>
	...
	<?php foreach($dataFakturPenawaran as $penawaran){ ?>
	<form action="<?php echo base_url(). 'Faktur_Penawaran/update'; ?>" method="post">
		<table style="margin:20px auto;">
			...
			<tr>
				...
				<td><input type="text" name="nm_user" value="<?php echo $penawaran->nm_user ?>"></td>
			</tr>
			<tr>
				<td>Nama Barang</td>
			...
			<tr>
				<td>Alamat</td>
				<td width="600px"><textarea type="text" name="alamat" value="<?php echo $penawaran->alamat ?>"></textarea></td>
			</tr>
			<tr>
				<td>PPN</td>
