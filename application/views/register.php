	...
	<div class="row">
			...
			<form action="<?php echo base_url()."index.php/user/RegisterUser"?>" method="post">
				<div class="form-group">
					...
					<div class="col-sm-5">
					  <input type="text" name="nama" style="width:600px;" class="form-control" value="<?php echo set_value('nama'); ?>" placeholder="Masukkan nama lengkap" id="nama">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
					  <input type="text" name="no_hp" style="width:600px;" class="form-control" value="<?php echo set_value('no_hp');?>" placeholder="Masukkan nomor HP" id="no_hp">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
					  <textarea type="text" name="alamat" style="width: 600px; height: 100px" class="form-control" value="<?php echo set_value('alamat'); ?>" placeholder="Masukkan alamat" id="alamat"></textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
					  <input type="email" name="email" style="width:600px;" class="form-control" value="<?php echo set_value('email');?>" placeholder="Masukkan email" id="email">
					</div>
				</div>
				<div class="form-group">
					<label for="confirm_email">Konfirmasi Email</label>
					<div class="col-sm-5">
					  <input type="text"  name="confirm_email" style="width:600px;" class="form-control" value="<?php echo set_value('confirm_email');?>" placeholder="Confirm email" id="confirm_email">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
					  <input type="text" name="keterangan" style="width:600px;" class="form-control" value="<?php echo set_value('keterangan'); ?>" placeholder="Masukkan keterangan" id="keterangan">
					</div>
				</div>
