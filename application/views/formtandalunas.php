...
<div class="container">
	...
	<div class="row">
			...
			<form action="<?php echo base_url()."index.php/Faktur_Tanda_Lunas/AddFakturTdLunas"?>" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
					  <input type="text" name="status" style="width:500px;" class="form-control" value="<?php echo set_value('status'); ?>" placeholder="Masukkan status" id="status">
					</div>
				</div>		
