...
<body>
  <?php
    foreach($dataFakturService as $service){ ?>
  <div class="span center">
	<h1 align="text-center"><?php echo $service->nm_user ?></h1>
	<br>
	<h1 align="text-center"><?php echo $service->pembeli ?></h1>
	<p align="text-center"><?php echo $service->alamat ?></p>
  <?php } ?>
  </div>
 	...
 	<table>
		...
		<tbody>
			<tr style="background-color: #26216A;">		
				<td><?php echo $service->nm_brg ?></td>
				<td>&nbsp;&nbsp;Rp <?php echo $service->hrg_satuan ?></td>
				<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $service->jml_brg ?></td>
				<td>Rp <?php echo $service->total_harga ?></td>
      </tr>
      <tr>
        <td style="background-color: #ffffff;"></td>
        <td colspan="2"; style="background-color: #26216A; color: #FA7B06;"> Total Tagihan </td>
        <td style="background-color: #26216A; color: #FA7B06;">Rp <?php echo $service->total_harga ?></td>
      </tr>
