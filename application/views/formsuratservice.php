...
<div class="container">
	...
	<div class="row">
			...
			<form action="<?php echo base_url()."index.php/Faktur_Service/AddFakturService"?>" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
					  <input type="text" name="keterangan" style="width:500px;" class="form-control" value="<?php echo set_value('keterangan'); ?>" placeholder="Masukkan keterangan" id="keterangan">
					</div>
				</div>	
