				...
				<div class="column ">
					<div class="card">
						...
						<div class="card-block">
							<a href="<?php echo base_url('Faktur_penawaran/index'); ?>" class="MyButton">Faktur Penawaran &nbsp;</a>
							<br>
							<br>
							<a href="<?php echo base_url('Faktur_pemesanan/index'); ?>" class="MyButton">Faktur Pemesanan&nbsp;</a>
							<br>
							<br>
							<a href="<?php echo base_url('Faktur_surat_jalan/index'); ?>" class="MyButton">Surat Jalan &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </a>
							<br>
							<br>
							<a href="<?php echo base_url('faktur_penagihan/index'); ?>" class="MyButton">Faktur Penagihan &nbsp;&nbsp;</a>
							<br>
							<br>
							<a href="<?php echo base_url('Faktur_Tanda_Lunas/index'); ?>" class="MyButton">Faktur Tanda Lunas</a>
							<br>
							<br>
							<a href="<?php echo base_url('Faktur_Service/index'); ?>" class="MyButton">Faktur Service &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
							<br>
							<br>
