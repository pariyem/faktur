...
<div class="container">
	...
	<div class="row">
			...
			<form action="<?php echo base_url()."index.php/Faktur_Surat_Jalan/AddFakturJalan"?>" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
					  <textarea type="text" name="total_harga" style="width:500px;" class="form-control" value="<?php echo set_value('total_harga'); ?>" placeholder="Masukkan total harga" id="total_harga"></textarea>
					</div>
				</div>
